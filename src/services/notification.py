...
class NotificationService:
    ...
    async def send_welcome_message(self, user_id: int, first_name: str):
        ...
        try:
            ...
            text = (
                f"🎉 Добро пожаловать в сервис стабильного соединения"
                f"  с небольшой базой пользователей - без очередей за скоростью и без посторонних, {first_name}!\n\n"
                f"Вот как начать:\n"
                f"1. 💰 Выберите тарифный план\n"
                f"2. 💳 Завершите оплату\n"
                f"3. 📱 Получите вашу конфигурацию\n"
